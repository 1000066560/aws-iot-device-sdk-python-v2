...
from samples.aws_blinkstick import blinkstick
...
def on_update_shadow_accepted(response):
    print(response)
    # color = response.state.reported[shadow_property]
...
if __name__ == '__main__':
    ...
    try:
        ...
        update_accepted_subscribed_future, _ = shadow_client.subscribe_to_named_shadow_updated_events(
